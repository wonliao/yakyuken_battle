...
$a.Screen = (function(){
    ...
    cls.prototype.drawDummyScoreboard = function(options){
        ...
        var t = $f.format('<span style="color:#FFF;">Max combos: {0}\nTotal combos: {1}\nTotal balls:\n<span style="font-size:48px; color:#F00;">{2}</span><span>',
            opts.maxComboCount, opts.totalComboCount, opts.totalBallCount);
        this._dummyScoreboard.html($f.nl2br(t));
		
		if( $a.player.state == 0 && opts.totalBallCount > 10 ) {
			console.log("win 1");
			$a.player.state = 1;
			document.images["d_img"].src="img/d/d2.png";
			document.images["d_img"].style.width="107px";
			document.images["d_img"].style.height="160px";
		} else if( $a.player.state == 1 && opts.totalBallCount > 20 ) {
			console.log("win 2");
			$a.player.state = 2;
			document.images["d_img"].src="img/d/d3.png";
			document.images["d_img"].style.width="107px";
			document.images["d_img"].style.height="160px";
		} else if( $a.player.state == 2 && opts.totalBallCount > 30 ) {
			console.log("win 3");
			$a.player.state = 3;
			document.images["d_img"].src="img/d/d4.png";
			document.images["d_img"].style.width="107px";
			document.images["d_img"].style.height="160px";
		}
    }
...
$a.Ball = (function(){
    ...
    cls.TYPE_CHOICES = {
        fire: {
            ...
            styles: { backgroundColor:'red', width:'52px', height:'52px' }
        },
        water: {
            imgUrl: $e.mediaUrl + '/img/ball/ball-water.png',
            styles: { backgroundColor:'aqua', width:'52px', height:'52px' }
        },
        wood: {
            imgUrl: $e.mediaUrl + '/img/ball/ball-wood.png',
            styles: { backgroundColor:'green', width:'52px', height:'52px' }
        },
        light: {
            imgUrl: $e.mediaUrl + '/img/ball/ball-light.png',
            styles: { backgroundColor:'yellow', width:'52px', height:'52px' }
        },
        dark: {
            imgUrl: $e.mediaUrl + '/img/ball/ball-dark.png',
            styles: { backgroundColor:'gray', width:'52px', height:'52px' }
        },
        heart: {
            imgUrl: $e.mediaUrl + '/img/ball/ball-heart.png',
            styles: { backgroundColor:'pink', width:'52px', height:'52px' }
        }//,
    }
